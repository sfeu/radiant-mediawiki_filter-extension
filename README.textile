...
# Install or update the "MediaCloth gem":http://mediacloth.rubyforge.org: 
...
h4. mediawiki_filter.add_blank? (default: true)

This enhancement makes sure all external URLs are opened in a blank browser window.

h4. mediawiki_filter.image_directory (default: '/images')
...
h4. mediawiki_filter.media_directory (default: nil)
...
h4. mediawiki_filter.enable_workarounds? (default: true)
